  ...
  <nav
    ...
    <div className="usa-identifier__container">
      <ul className="usa-identifier__required-links-list">
        ...
        <li className="usa-identifier__required-links-item">
          <a href="https://www.consumerfinance.gov/accessibility/" className="usa-identifier__required-link usa-link"
            >Accessibility support
          </a>
        </li>
        <li className="usa-identifier__required-links-item">
          <a href="https://www.consumerfinance.gov/foia-requests/" className="usa-identifier__required-link usa-link"
            >FOIA requests
          </a>
        </li>
        <li className="usa-identifier__required-links-item">
          <a href="https://www.consumerfinance.gov/privacy/email-campaign-privacy-act-statement/" className="usa-identifier__required-link usa-link"
            >Privacy policy
          </a>
        </li>
        <li className="usa-identifier__required-links-item">
          <a className="usa-identifier__required-link usa-link" href="https://www.ffiec.gov/hmda/">FFIEC HMDA Website</a>
        </li>
        <li className="usa-identifier__required-links-item">
          <a className="usa-identifier__required-link usa-link" href="https://www.federalregister.gov/documents/2015/10/28/2015-26607/home-mortgage-disclosure-regulation-c">
            HMDA Final Rule
          </a>
        </li>
        <li className="usa-identifier__required-links-item">
          <a className="usa-identifier__required-link usa-link" href="https://www.consumerfinance.gov/policy-compliance/guidance/implementation-guidance/hmda-implementation/">
            Regulatory Implementation Resources
          </a>
        </li>
        <li className="usa-identifier__required-links-item">
          <a className="usa-identifier__required-link usa-link" href="mailto:hmdahelp@cfpb.gov">Contact Us</a>
        </li>
      </ul>
    </div>
  </nav>
